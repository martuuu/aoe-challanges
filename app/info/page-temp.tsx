            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex items-start gap-2">
                  ...
                  <span>Si ganas contra alguien de nivel superior, intercambias posiciones</span>
                </li>
                <li className="flex items-start gap-2">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="space-y-3">
            ...
            <div className="text-sm text-gray-700 space-y-2">
              ...
              <p>
                • <strong>Victoria:</strong> Ganas puntos basado en la diferencia de ELO con tu
                oponente
              </p>
              <p>
                • <strong>Derrota:</strong> Pierdes puntos de manera proporcional al ELO de tu
                oponente
              </p>
              <p>
                • <strong>Factor K:</strong> 32 para cambios dinámicos y competitivos
              </p>
              <p>
                • <strong>Cálculo automático:</strong> El ELO se actualiza automáticamente después
                de cada partida
              </p>
            </div>
          </div>
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="relative">
          ...
          <div className="h-[600px] overflow-hidden relative">
            ...
            <button
              onClick={prevSlide}
              className="absolute left-4 bottom-4 z-10 bg-white/90 hover:bg-white border border-green-200 rounded-full p-2 shadow-lg transition-all duration-200 hover:shadow-xl"
            >
            ...
            <button
              onClick={nextSlide}
              className="absolute right-4 bottom-4 z-10 bg-white/90 hover:bg-white border border-green-200 rounded-full p-2 shadow-lg transition-all duration-200 hover:shadow-xl"
            >
